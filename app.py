#AISAI: Your AI Powered Sales and Insights Assistant | v27
...
selected_model = st.sidebar.selectbox(
    ...
    options=[
        ...
        "Groq Model B", 
        "Groq Model C", 
        "ChatGPT-4o-Latest (coming soon)", 
        "Gemini-EXP-1206 (coming soon)", 
        "Llama (coming soon)", 
        "StabilityAI (coming soon)", 
        "Yi-Lightning (coming soon)"
    ]
)

if "(coming soon)" in selected_model:
...
demo_data = {
    ...
    "target_customer": "High end gamers and AI and ML Developers & Engineers"
}
...
# Demo data and clear form buttons
col1, col2 = st.columns([0.5, 0.5])
with col1:
    if st.button("Use demo data"):
        st.session_state.use_demo_data = True
with col2:
    if st.button("Clear form data", key="clear_form_data_1"):
        st.session_state.use_demo_data = False
